  ...
  return (
    <html lang="en">
      <body className='bg-linear-to-l from-blue-300 to-green-400'>
        <nav className='sticky top-0 bg-red-500 h-16 flex items-center border-b-2 border-white pl-5 pr-3'>
          <h1 className='logoName text-white text-xl flex'><Image src={logoImg} alt='this is the Logo Image' height={30} className='bg-white mr-2 p-1 rounded-4xl animate-[spin_4s_linear_infinite]'/><span className='text-amber-300'>M</span>asum <span className='text-green-400 ml-1'>M</span>ahmud</h1>
          <ul className='grid grid-cols-2 ml-10 space-x-2 text-green-100 cursor-pointer'>
